...
function isCriticalInline(code = '') {
  return (
    /dgsToggle|dgsSvc|dgsLockScroll|dgsOpenTalkPopup|dgsNav|dgs-v1215|__DGS_PORTFOLIO|lightbox|dgsLogo|portfolioData|initPortfolio|bootMotion|initThree|envira_gallery/.test(
      code
...
export async function getWpHomeMirror({ revalidate = 300 } = {}) {
  ...
  // Critical frontend scripts only (menu, WebGL bg, portfolio lightbox, Envira)
