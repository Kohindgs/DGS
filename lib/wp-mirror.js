...
export function relocateHeroAboutSection(html = '', demoOrigin = DEMO_ORIGIN) {
  if (/id=["']dgs-about["']/.test(html) && /dgs-v1215-about-head/.test(html)) return html;
  // Replace an older about layout if present so deploys upgrade cleanly.
  let base = html.replace(
    /<section class=["']dgs-v1215-about["'][\s\S]*?<\/section>/i,
    ''
  );
...
<section class="dgs-v1215-about" id="dgs-about" aria-label="About Us">
  ...
  <div class="dgs-v1215-about-media dgs-v1215-reveal">
    <button type="button" class="dgs-about-video" data-dgs-yt="YbeRRCXA_ZE" aria-label="Play D'Genius Solutions anthem video">
      <img src="https://i.ytimg.com/vi/YbeRRCXA_ZE/hqdefault.jpg" alt="D'Genius Solutions anthem video" width="1280" height="720" loading="lazy" decoding="async" />
